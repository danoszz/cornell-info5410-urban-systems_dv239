...
export default function SoftSystems() {
  return (
    <div className={styles.container}>
      <Head>
        <title>Soft Systems - Affordable Housing Locations in NY</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <Header
        title="Urban Systems"
        subtitle="Data Visualisations"
        meta="A2 - 102521 - DV239"
      />
      <main>
        ...
        <section className={styles.content}>
          <header className={styles.articleHeader}>
            <h1 className={styles.title}>
              Mapping Location Affordability in NY
            </h1>
            <p className={styles.description}>Soft Systems</p>
          </header>
